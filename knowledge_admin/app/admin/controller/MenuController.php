...
class MenuController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        foreach ($result as $key => $value) {
            ...
            $add_url = "javascript:admin.openIframeLayer('".url("Menu/add", ["id" => $value['id'],"menu_id" => $this->request->param("menu_id")])."','添加子菜单',{btn: ['添加','关闭'],area:['640px','50%'],end:function(){}});";
            $edit_url = "javascript:admin.openIframeLayer('".url("Menu/edit", ["id" => $value['id'],"menu_id" => $this->request->param("menu_id")])."','编辑',{btn: ['保存','关闭'],area:['640px','50%'],end:function(){}});";
            $result[$key]['str_manage']     = '<a class="layui-bo layui-bo-small layui-bo-succes" href="' . $add_url . '">' . lang('ADD_SUB_MENU') . '</a> 
                                               <a class="layui-bo layui-bo-small layui-bo-checked" href="' . $edit_url . '">' . lang('EDIT') . '</a>  
                                               <a class="layui-bo layui-bo-small layui-bo-close js-ajax-delete" href="' . url("Menu/delete", ["id" => $value['id'], "menu_id" => $this->request->param("menu_id")]) . '">' . lang('DELETE') . '</a> ';
