...
class NavMenuController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        foreach ($arrResult as $r) {
            $r['str_manage'] = '<a class="layui-bo layui-bo-small" href="' . url("NavMenu/add", ["parent_id" => $r['id'], "nav_id" => $r['nav_id']]) . '">添加子菜单</a>
            <div class="new-divider new-divider-vertical"></div>
            <a class="layui-bo layui-bo-small layui-bo-checked" href="' . url("NavMenu/edit", ["id" => $r['id'], "parent_id" => $r['parent_id'], "nav_id" => $r['nav_id']]) . '">编辑</a> 
            <div class="new-divider new-divider-vertical"></div>
            <a class="layui-bo layui-bo-small layui-bo-close js-ajax-delete" href="' . url("NavMenu/delete", ["id" => $r['id'], 'nav_id' => $r['nav_id']]) . '">删除</a> ';
            $r['status']     = $r['status'] ? '<span class="layui-badge-dot layui-bg-function" style="margin-right: 6px;"></span>' . lang('DISPLAY') . '</span>' : '<span class="layui-badge-dot layui-bg-abnormal" style="margin-right: 6px;"></span>' . lang('HIDDEN') . '</span>';
            $array[]         = $r;
        }
