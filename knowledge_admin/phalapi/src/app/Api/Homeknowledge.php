 ...
 * 知识付费首页
 */
class Homeknowledge extends Api {
     ...
     * @return array info[0].hotlist 热门精选 同课程列表
    ...
    public function getIndex() {
        ...
        /* 课程分类 */
        $Domain_Knowledge = new Domain_Knowledge();
        $courseclass = $Domain_Knowledge->getClass();
        $info['courseclass']=$courseclass;

        /*热门精选*/
        $hotList = $Domain_Knowledge->getHot(3); //取前3个
        ...
        $live = $Domain_Knowledge->getList(1,$where3,'list_order asc,id desc',6);
        $info['live']=$live;
        ...
        $list = $Domain_Knowledge->getList(1,$where4,'list_order asc,id desc',4);
        $info['list']=$list;
