...
<div class="body kaiyuan_body">
    ...
    <div class="zhibo_wrap">
        ...
        <div class="tips">
            ...
            <div style="display: inline-block; width: 92%; text-align: right;">
                <a style="color:#9e9a9a" href="<?php echo url('student/lessionlist/index'); ?>">更多></a>
            </div>
        </div>
        <ul>
    ...
    <div class="tips">
        <span>精选内容</span>
        <div style="display: inline-block; width: 92%; text-align: right;">
            <a style="color:#9e9a9a" href="<?php echo url('student/lessionlist/index',['flag' => 'neirong']); ?>">更多></a>
        </div>
    </div>
    <ul>
