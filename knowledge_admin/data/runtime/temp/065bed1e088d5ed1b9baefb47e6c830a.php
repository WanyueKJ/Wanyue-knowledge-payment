<?php /*a:2:{s:78:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/knowledge/index.html";i:1612836862;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-page-header-content">
                    ...
                    <div class="layui-tab layui-tab-brief">
                        <ul class="layui-tab-title layui-nav" id="tabHeader">
                            ...
                            <!--                                <li><a href="javascript:admin.openIframeLayer('<?php echo url('knowledge/add',['sort'=>$sort]); ?>','<?php echo lang('ADMIN_USER_ADD'); ?>',{btn: ['保存','关闭'],area:['640px','50%'],end:function(){location.reload();}});"><?php echo lang('ADD'); ?></a></li>-->
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="layui-bo layui-bo-small layui-bo-checked" href="<?php echo url("knowledge/edit",array("id"=>$vo["id"])); ?>"><?php echo lang('EDIT'); ?></a>
                                    <div class="new-divider new-divider-vertical"></div>
