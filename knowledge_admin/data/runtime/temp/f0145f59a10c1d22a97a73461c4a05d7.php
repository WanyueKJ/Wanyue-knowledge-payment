<?php /*a:2:{s:73:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/slide/edit.html";i:1586325804;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<form method="post" class="layui-form js-ajax-form" action="<?php echo url('slide/editPost'); ?>" style="padding: 20px 30px 0 0;">
	<div class="layui-form-item">
		<label class="layui-form-label"><span class="form-required">*</span>名称</label>
		<div class="layui-input-inline">
			<input type="text" class="layui-input" id="input-name" required lay-verify="required" name="name" value="<?php echo $result['name']; ?>">
		</div>
	</div>
	<div class="layui-form-item">
		<label for="input-remark" class="layui-form-label"><?php echo lang('DESCRIPTION'); ?></label>
		<div class="layui-input-block">
			<textarea class="layui-textarea" id="input-remark" name="remark"><?php echo $result['remark']; ?></textarea>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-input-block">
