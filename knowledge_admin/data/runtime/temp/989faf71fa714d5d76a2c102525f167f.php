<?php /*a:2:{s:78:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/admin/users/index.html";i:1607594773;s:74:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/public/header.html";i:1602491838;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <?php 
             ...
             if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <?php if(($vo['id'] != 27) && ($vo['id'] != 1)): if($vo['user_status'] == 0): ?>
