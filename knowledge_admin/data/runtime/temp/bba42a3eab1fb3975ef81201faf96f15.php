<?php /*a:2:{s:102:"D:\My_project\wanyue_education_web_local\education_web/themes/admin_simpleboot3/admin\course\edit.html";i:1603508170;s:98:"D:\My_project\wanyue_education_web_local\education_web/themes/admin_simpleboot3/public\header.html";i:1602491837;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('course/editPost'); ?>">
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control getuid" id="input-uid" name="uid" value="<?php echo $data['uid']; ?>"  autocomplete="off">
                    <div class="userlist">
                        <ul>
                        </ul>
                    </div>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control getuid" id="input-tutoruid" name="tutoruid"  autocomplete="off" value="<?php if($data['tutoruid'] > 0): ?><?php echo $data['tutoruid']; ?><?php endif; ?>">
                    <div class="userlist">
                        <ul>
                        </ul>
                    </div>
