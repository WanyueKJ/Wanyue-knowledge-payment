<?php /*a:2:{s:77:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/rbac/role_edit.html";i:1586334596;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<form class="layui-form js-ajax-form" action="<?php echo url('rbac/roleeditpost'); ?>" method="post" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        <label for="input-name" class="layui-form-label">
            <span class="form-required">*</span><?php echo lang('ROLE_NAME'); ?></label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" id="input-name" required lay-verify="required" name="name" value="<?php echo $data['name']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label for="input-remark" class="layui-form-label"><?php echo lang('ROLE_DESCRIPTION'); ?></label>
        <div class="layui-input-block">
            <textarea type="text" class="layui-textarea" id="input-remark" name="remark"><?php echo $data['remark']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-input-inline">
                <?php $strMainMenuChecked=$data['status']?"checked":""; ?>
                <input type="checkbox" name="status" lay-skin="switch" id="status" lay-filter="status" value="<?php echo $data['status']; ?>"
                       lay-text="<?php echo lang('ENABLED'); ?>|<?php echo lang('DISABLED'); ?>" <?php echo $strMainMenuChecked; ?>>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
