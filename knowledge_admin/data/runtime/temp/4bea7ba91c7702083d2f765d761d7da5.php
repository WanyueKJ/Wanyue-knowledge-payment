<?php /*a:2:{s:97:"D:\My_project\Wanyue-knowledge-payment-admin/themes/admin_htcyltd/admin\knowledgeclass\index.html";i:1614582254;s:84:"D:\My_project\Wanyue-knowledge-payment-admin/themes/admin_htcyltd/public\header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
            ...
            <div class="layui-page-header-content">
                <div class="layui-card-body">
                    <div class="layui-ui-page-header-title">
                        知识付费分类<span class="layui-badge-rim page-content">知识付费分类</span>
                    </div>
                </div>
                <div class="layui-tab layui-tab-brief">
                    <ul class="layui-tab-title layui-nav" id="tabHeader">
                        <li class="layui-this layui-nav-item"><a href="<?php echo url('knowledgeclass/index'); ?>">列表</a></li>
                        <li class="layui-nav-item">
                            <a href="<?php echo url('knowledgeclass/add'); ?>"><?php echo lang('ADD'); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="layui-page-content">
        <div class="layui-card">
            <form method="post" class="layui-card-body js-ajax-form" action="<?php echo url('knowledgeclass/listOrder'); ?>">
                ...
                <table class="layui-table treeTable" lay-even lay-skin="nob" lay-size="lg">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                        <tr>
                            ...
                            <td>
                                <a class="layui-bo layui-bo-small layui-bo-checked" href='<?php echo url("knowledgeclass/edit",array("id"=>$vo["id"])); ?>'><?php echo lang('EDIT'); ?></a>
                                <a class="layui-bo layui-bo-small layui-bo-close js-ajax-delete" href="<?php echo url('knowledgeclass/del',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
                            </td>
                        </tr>
