<?php /*a:2:{s:80:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/coursegrade/index.html";i:1609930421;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
            ...
            <div class="layui-page-header-content">
                <div class="layui-card-body">
                    <div class="layui-ui-page-header-title">
                        学级分类<span class="layui-badge-rim page-content">归类课程</span>
                    </div>
                </div>
                <div class="layui-tab layui-tab-brief">
                    <ul class="layui-tab-title layui-nav" id="tabHeader">
                        <li class="layui-this layui-nav-item"><a href="<?php echo url('coursegrade/index'); ?>">列表</a></li>
                        <li class="layui-nav-item">
                            <a href="javascript:admin.openIframeLayer('<?php echo url('coursegrade/add'); ?>','添加分类',{btn: ['保存','关闭'],area:['640px','50%'],end:function(){}});">添加</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="layui-page-content">
        <div class="layui-card">
            <form class="layui-card-body js-ajax-form" action="<?php echo url('coursegrade/listOrder'); ?>" method="post">
                <button class="layui-btn js-ajax-submit" type="submit"><?php echo lang('SORT'); ?></button>
                <table id="menus-table" class="layui-table treeTable" lay-even lay-skin="nob" lay-size="lg">
                    <thead>
                    <tr>
