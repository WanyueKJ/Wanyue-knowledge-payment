<?php /*a:2:{s:108:"D:\My_project\wanyue_education_web_local\education_web/themes/admin_simpleboot3/admin\setting\configpri.html";i:1604301632;s:98:"D:\My_project\wanyue_education_web_local\education_web/themes/admin_simpleboot3/public\header.html";i:1602491837;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="#D" data-toggle="tab">极光配置</a></li>
    </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-10">
                                <input type="text" class="form-control" id="input-tx_api_secretid" name="options[tx_api_secretid]" value="<?php echo (isset($config['tx_api_secretid']) && ($config['tx_api_secretid'] !== '')?$config['tx_api_secretid']:''); ?>">  短信验证码 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-10">
                                <input type="text" class="form-control" id="input-tx_api_secretkey" name="options[tx_api_secretkey]" value="<?php echo (isset($config['tx_api_secretkey']) && ($config['tx_api_secretkey'] !== '')?$config['tx_api_secretkey']:''); ?>">  短信验证码 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-10">
                                <input type="text" class="form-control" id="input-tx_sms_sdkappid" name="options[tx_sms_sdkappid]" value="<?php echo (isset($config['tx_sms_sdkappid']) && ($config['tx_sms_sdkappid'] !== '')?$config['tx_sms_sdkappid']:''); ?>">  短信验证码 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-10">
                                <input type="text" class="form-control" id="input-tx_sms_sign" name="options[tx_sms_sign]" value="<?php echo (isset($config['tx_sms_sign']) && ($config['tx_sms_sign'] !== '')?$config['tx_sms_sign']:''); ?>">  短信验证码 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-10">
                                <input type="text" class="form-control" id="input-tx_sms_tempid" name="options[tx_sms_tempid]" value="<?php echo (isset($config['tx_sms_tempid']) && ($config['tx_sms_tempid'] !== '')?$config['tx_sms_tempid']:''); ?>">  短信验证码 
                            </div>
                        </div>
                    ...
                    <div class="tab-pane" id="C">
                        ...
                        <div <?php if(config('type') != 0): ?>style="display:none;"<?php endif; ?> >
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sound_appid" name="options[sound_appid]" value="<?php echo (isset($config['sound_appid']) && ($config['sound_appid'] !== '')?$config['sound_appid']:''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-agora_api_id" name="options[agora_api_id]" value="<?php echo (isset($config['agora_api_id']) && ($config['agora_api_id'] !== '')?$config['agora_api_id']:''); ?>">声网后台 ->右上角->RESTful API
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-agora_api_key" name="options[agora_api_key]" value="<?php echo (isset($config['agora_api_key']) && ($config['agora_api_key'] !== '')?$config['agora_api_key']:''); ?>">声网后台 ->右上角->RESTful API
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="D">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">极光推送模式</label>
                            <div class="col-md-6 col-sm-10">
