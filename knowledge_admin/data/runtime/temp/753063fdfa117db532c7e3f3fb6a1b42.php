<?php /*a:2:{s:80:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/setting/configpri.html";i:1612916655;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="layui-form js-ajax-form" role="form" action="<?php echo url('admin/setting/configpripost'); ?>" method="post" wid110>
                        <div class="layui-tab-content" id="tabBody">
                            ...
                            <div class="layui-tab-item">
                                ...
                                <!--小程序相关配置-->
                                <div class="layui-form-item">
                                    <label for="input-small_appid" class="layui-form-label">小程序移动应用AppID</label>
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input" id="input-small_appid" name="options[small_appid]" value="<?php echo (isset($config['small_appid']) && ($config['small_appid'] !== '')?$config['small_appid']:''); ?>">
                                    </div>
                                </div>

                                <div class="layui-form-item">
                                    <label for="input-small_appsecret" class="layui-form-label">小程序移动应用appsecret</label>
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input" id="input-small_appsecret" name="options[small_appsecret]" value="<?php echo (isset($config['small_appsecret']) && ($config['small_appsecret'] !== '')?$config['small_appsecret']:''); ?>">
                                    </div>
                                </div>

                                <div class="layui-form-item">
                                    <label for="input-small_mchid" class="layui-form-label">小程序商户号mchid</label>
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input" id="input-small_mchid" name="options[small_mchid]" value="<?php echo (isset($config['small_mchid']) && ($config['small_mchid'] !== '')?$config['small_mchid']:''); ?>"> 小程序商户号mchid（微信开放平台小程序移动应用 对应的微信商户 商户号mchid）
                                    </div>
                                </div>

                                <div class="layui-form-item">
                                    <label for="input-small_key" class="layui-form-label">小程序密钥key</label>
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input" id="input-small_key" name="options[small_key]" value="<?php echo (isset($config['small_key']) && ($config['small_key'] !== '')?$config['small_key']:''); ?>"> 小程序密钥key（微信开放平台小程序移动应用 对应的微信商户 密钥key）
                                    </div>
                                </div>
