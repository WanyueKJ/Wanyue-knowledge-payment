<?php /*a:3:{s:81:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/admin/plugin/setting.html";i:1602491838;s:83:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/admin/plugin/functions.html";i:1602491838;s:74:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/public/header.html";i:1602491838;}*/ ?>
<?php 
 ...
 if(is_array($pluginConfig) || $pluginConfig instanceof \think\Collection || $pluginConfig instanceof \think\Paginator): if( count($pluginConfig)==0 ) : echo "" ;else: foreach($pluginConfig as $key=>$form): switch($form['type']): case "explain": ?>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <p class="form-control-static"><?php echo $form['value']; ?></p>
        ...
        <?php break; case "text": ?>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input type="text" name="config[<?php echo $key; ?>]" class="form-control" <?php echo !empty($form['disabled']) ? 'disabled' : ''; ?> value="<?php echo $form['value']; ?>" id="<?php echo $key; ?>">
                    <?php if(isset($form['tip'])): ?>
                        <p class="help-block"><?php echo $form['tip']; ?></p>
                    <?php endif; ?>
                </div>
        ...
        <?php break; case "number": ?>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input type="number" name="config[<?php echo $key; ?>]" class="form-control" <?php echo !empty($form['disabled']) ? 'disabled' : ''; ?> value="<?php echo $form['value']; ?>"
                           id="<?php echo $key; ?>">
                    <?php if(isset($form['tip'])): ?>
                        <p class="help-block"><?php echo $form['tip']; ?></p>
                    <?php endif; ?>
        ...
        <?php break; case "textarea": ?>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <textarea class="form-control" name="config[<?php echo $key; ?>]" <?php echo !empty($form['disabled']) ? 'disabled' : ''; ?> id="<?php echo $key; ?>"><?php echo $form['value']; ?></textarea>
                    <?php if(isset($form['tip'])): ?>
                        <p class="help-block"><?php echo $form['tip']; ?></p>
                    <?php endif; ?>
                </div>
        ...
        <?php break; case "file": ?>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <div>
                        <input class="form-control" id="js-<?php echo $key; ?>-input" type="text" name="config[<?php echo $key; ?>]" value="<?php echo $form['value']; ?>"
                               style="width: 300px;display: inline-block;" title="文件名称">
                        <a href="javascript:uploadOne('文件上传','#js-<?php echo $key; ?>-input','file');">上传文件</a>
                    </div>
                    <?php if(isset($form['tip'])): ?>
                        <p class="help-block"><?php echo $form['tip']; ?></p>
                    <?php endif; ?>
