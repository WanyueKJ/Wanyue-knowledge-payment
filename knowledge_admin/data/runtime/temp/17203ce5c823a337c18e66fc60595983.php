<?php /*a:2:{s:81:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/knowledgebuy/index.html";i:1612838681;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    <div class="layui-row">
        ...
        <div class="layui-page-content">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form" method="post" action="<?php echo url('Knowledgebuy/index'); ?>">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline">
                                ...
                                <a class="layui-btn layui-btn-danger btn-danger" href="<?php echo url('Knowledgebuy/index',['courseid'=>$courseinfo['id']]); ?>">清空</a>
                            </div>
                        </div>
