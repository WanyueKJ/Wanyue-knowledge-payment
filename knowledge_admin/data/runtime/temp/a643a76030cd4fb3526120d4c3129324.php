<?php /*a:8:{s:101:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student\teachers\index.html";i:1603264798;s:90:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/public\head.html";i:1602491837;s:98:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student/public\head.html";i:1602491837;s:100:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student/public\header.html";i:1603447313;s:99:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student/public\grade.html";i:1602491837;s:99:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student/public\login.html";i:1602491837;s:100:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student/public\footer.html";i:1602666102;s:101:"D:\My_project\wanyue_education_web_local\education_web/themes/simpleboot3/student/public\scripts.html";i:1603268576;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="teachers_content">
        <div class="left">
            <div class="top">名师团队</div>

            <?php if(is_array($kmlist) || $kmlist instanceof \think\Collection || $kmlist instanceof \think\Paginator): $i = 0; $__LIST__ = $kmlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <a class="li <?php if($key == 0): ?>on<?php endif; ?>" href="javacript:void(0);" data-id="<?php echo $item['id']; ?>" data-name="<?php echo $item['name']; ?>"><?php echo $item['name']; ?></a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>

        <div class="right">
            <div class="tips">
                <img class="leftimg" src="/static/student/images/teachers/left.png">
                <text>
                    <?php if($kmlist != []): ?>
                        <span id="classname"><?php echo $kmlist[0]['name']; ?></span>主讲教师
                    <?php endif; ?>
                </text>
                <img class="rightimg" src="/static/student/images/teachers/right.png">
            </div>

            <div class="tit">排名不分先后</div>

            <div class="mess">
                <?php if(is_array($techerslist) || $techerslist instanceof \think\Collection || $techerslist instanceof \think\Paginator): $i = 0; $__LIST__ = $techerslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <div class="li">
                        <div class="avatar">
                        ...
                        <div class="bottom">
                            <?php if($item['isAttent'] == 1): ?>
                                <a class="a1_0" data-uid="<?php echo $item['id']; ?>" href="javacript:void(0);">已关注</a>
                            <?php else: ?>
                                <a class="a1" data-uid="<?php echo $item['id']; ?>" href="javacript:void(0);">+ 关注</a>
                            <?php endif; ?>
...
<script src="/static/swiper/swiper.min.js"></script>
    ...
    <script>
        var page = 1;//页码
        var classid = '<?php echo $classid; ?>'; //专长id
    </script>
