<?php /*a:2:{s:79:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/coursegrade/edit.html";i:1609930662;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    <form method="post" class="layui-form js-ajax-form" style="margin-top: 20px;" action="<?php echo url('coursegrade/editPost'); ?>">
        ...
        <div class="layui-input-block">
            ...
            <select class="layui-input" disabled>
                ...
                <?php if(is_array($classs) || $classs instanceof \think\Collection || $classs instanceof \think\Paginator): $i = 0; $__LIST__ = $classs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    ...
                    <?php if($data['pid'] == $v['id']): ?>selected<?php endif; ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" required lay-verify="required" class="layui-input" id="input-name" name="name"
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <button type="submit" id="js-ajax-submit" class="layui-btn  js-ajax-submit js-close"><?php echo lang('EDIT'); ?>
            </button>
        </div>
    </div>
