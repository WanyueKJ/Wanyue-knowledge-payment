...
<div class="my_container">
    ...
    <div class="my_right">
        <div class="my_right_top">
            <div class="my_right_title">我的消息</div>
        </div>
        <div class="my_right_button">
            <div class="message_nav">
                <a href="javascript:void(0)" class="nav_li">
                    系统消息
                    <div class="heng"></div>
                </a>
                <a href="javascript:void(0)" class="nav_li">
            ...
            <div class="nav_li_list">
                <?php if(is_array($syslist) || $syslist instanceof \think\Collection || $syslist instanceof \think\Paginator): $i = 0; $__LIST__ = $syslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <div class="content_li">
                        <div class="date"><?php echo $item['addtime']; ?></div>
                        <div class="content"><?php echo $item['content']; ?></div>
                    </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="nav_li_list none">
                <?php if(is_array($classlist) || $classlist instanceof \think\Collection || $classlist instanceof \think\Paginator): $i = 0; $__LIST__ = $classlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <div class="content_li">
                        <div class="date"><?php echo $item['addtime']; ?></div>
                        <div class="content"><?php echo $item['content']; ?></div>
                    </div>
            ...
            <div class="nav_li_list none">
                <?php if(is_array($teacherlist) || $teacherlist instanceof \think\Collection || $teacherlist instanceof \think\Paginator): $i = 0; $__LIST__ = $teacherlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <div class="content_li">
                        <div class="date"><?php echo $item['addtime']; ?></div>
                        <div class="content"><?php echo $item['content']; ?></div>
                    </div>
