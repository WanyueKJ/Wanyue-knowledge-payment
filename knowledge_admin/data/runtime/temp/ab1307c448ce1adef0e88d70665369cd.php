...
<body>
    ...
    <div class="content">
        ...
        <div class="right">
            <div class="search">
                ...
                <!-- <div id="search"><a href="javacript:void(0);" class="white">搜索</a></div> -->
    ...
    <div class="detail_kc">
            ...
            <div class="content">
                ...
                <div class="msg">
                    ...
                    <?php else: if($info['paytype'] == 0): ?>
                        ...
                        <?php endif; if($info['paytype'] == 1 && $info['ifbuy'] == 0): if($info['iscart'] == 1): ?><button class="yCart">已加购物车</button><?php else: ?><button data-id="<?php echo $info['id']; ?>" class="addCart">加入购物车</button><?php endif; ?><button class="goBuy">立即购买</button>
                        <?php endif; if(($info['paytype'] == 1 && $info['ifbuy'] == 1) || $info['paytype'] == 0 || ($info['paytype'] == 2 && $info['ifbuy'] == 1)): ?>
                            <button class="comment">发表评价</button>
                        <?php endif; ?>
        ...
        <div class="bcontent">
            ...
            <div class="area2 none">
                ...
                <div class="classlist">
                    <?php if(is_array($lessonlist) || $lessonlist instanceof \think\Collection || $lessonlist instanceof \think\Paginator): $i = 0; $__LIST__ = $lessonlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <div class="li">
                            <div class="title">
                                <?php echo $item['name']; ?>
                                <img class="up" src="/static/student/images/detail/up.png">
                                <img class="down none" src="/static/student/images/detail/down.png">
                            </div>
                            <div class="zj">
                                <?php if(is_array($item['list']) || $item['list'] instanceof \think\Collection || $item['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item1): $mod = ($i % 2 );++$i;?>
                                    <div style="cursor:pointer;" class="lix" data-islive="<?php echo $item1['islive']; ?>"  data-url="<?php echo $item1['url']; ?>" data-type="<?php echo $item1['type']; ?>" data-isenter="<?php echo $item1['isenter']; ?>" data-id="<?php echo $item1['id']; ?>">
                                        <div class="xuhao"><?php echo $key+1; ?></div>
                                        <div class="middle">
                                            <div class="tops">
                                                <text class="text1 <?php if($item1['isenter'] == 0): ?>c_c969696<?php endif; ?>"><?php echo $item1['name']; ?></text>
                                                <?php if($item1['islast'] == 1): ?>
                                            ...
                                            <div class="bottom">
                                                ...
                                                <?php elseif($item1['type'] == 2): ?>
                                                    <text class="bq">视频</text>
                                                <?php elseif($item1['type'] == 3): ?>
                                                    <text class="bq">音频</text>
                                                <?php else: ?>
                                                    <text class="bq">直播</text>
                                                <?php endif; if($item1['type'] > 3): if($item1['islive'] == 0): ?>
                                                        <text class="time"><?php echo $item1['time_date']; ?></text>
                                                    <?php elseif($item1['islive'] == 2): ?>
                                        ...
                                        <div class="right">
                                            ...
                                            <?php elseif($item1['status'] == 2): ?>
                                                <text>已学完</text>
                                            <?php elseif($item1['status'] == 3): ?>
                                                <text class="on">正在直播</text>
                                            <?php elseif($item1['status'] == 4): ?>
                                                <img class="suo none" src="/static/student/images/detail/suo.png">
                                            <?php endif; ?>
            ...
            <div class="area3 none">
                <div class="tip ">
                    <text>课程评价（<?php echo $info['comments']; ?>）</text>
                </div>
                <div class="commentlist">
                    <?php if(is_array($commentlist) || $commentlist instanceof \think\Collection || $commentlist instanceof \think\Paginator): $i = 0; $__LIST__ = $commentlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <div class="li">
                            ...
                            <div class="mess">
                                <div class="name"><?php echo $item['user_nickname']; ?></div>
                                <div class="star">
                                    <?php if($item['star'] == 0): ?>
                                ...
                                <div class="comon"><?php echo $item['content']; ?></div>
                            </div>
                            <div class="date">
    ...
    <div class="common_zhe none">
        <div class="table">
            <div class="top">
                <text>发表言论</text>
                <img src="/static/student/images/detail/black_cha.png">
            </div>
            <div class="content">
                <div>评价课程：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $info['name']; ?></div>
                <div class="li2">星级评分：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span>
                        <img class="starimg" src="/static/student/images/detail/star_no.png">
                        <img class="starimg" src="/static/student/images/detail/star_no.png">
...
<script src="/static/swiper/swiper.min.js"></script>
    ...
    <script>
        ...
        var ifbuy = "<?php echo $info['ifbuy']; ?>"; //是否购买
    </script>
