...
<div class="my_container">
    ...
    <div class="my_right">
        <div class="my_right_top">
            <div class="my_right_title">账号设置</div>
        </div>
        <div class="my_right_button">
            ...
            <div class="usermess_info">
                ...
                <div class="tips">上传真实头像有助于老师更快的记住你</div>
            </div>
            <div class="usermess_name">
                <div class="text">昵称：</div>
                <input name="user_nickname" class="inputname" value="<?php echo $baseinfo['user_nickname']; ?>" placeholder="输入昵称" />
            </div>
...
<script>
    var avatar = '';//头像地址
    var user_nickname = "<?php echo $baseinfo['user_nickname']; ?>";//昵称
</script>
