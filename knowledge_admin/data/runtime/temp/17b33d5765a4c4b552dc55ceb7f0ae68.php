<?php /*a:2:{s:74:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/course/edit.html";i:1612840960;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    ...
    <form method="post" class="layui-form js-ajax-form" style="margin-top: 20px;" action="<?php echo url('course/editPost'); ?>">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-tab layui-tab-brief">
                    <ul class="layui-tab-title">
                        <li><a href="<?php echo url('course/index',['sort'=>$sort]); ?>">列表</a></li>
                        <li class="layui-this"><a href="<?php echo url('course/edit',['sort'=>$sort]); ?>">编辑</a></li>
                    </ul>
                            ...
                            <div class="layui-input-block">
                                <select class="layui-input" name="gradeid">
                                    <?php if(is_array($grade) || $grade instanceof \think\Collection || $grade instanceof \think\Paginator): $i = 0; $__LIST__ = $grade;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                        ...
                                        <?php if($data['gradeid'] == $v['id']): ?>selected<?php endif; ?>
