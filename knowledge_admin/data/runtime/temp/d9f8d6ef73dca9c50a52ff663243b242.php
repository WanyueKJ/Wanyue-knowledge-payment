<?php /*a:2:{s:88:"D:\My_project\Wanyue-knowledge-payment-admin/themes/admin_htcyltd/user\\webuploader.html";i:1608253112;s:84:"D:\My_project\Wanyue-knowledge-payment-admin/themes/admin_htcyltd/public\header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-row layui-tab">
    <div class="layui-side" style="background: #f5f7f9;">
        <ul class="layui-if-menu" id="tabHeader">
            <li class="<?php echo $tab=='local' ? 'layui-this' : ''; ?>"><i class="icon-icon layui-icon-android-upload"></i>上传文件</li>
<!--            <li class="<?php echo $tab=='url' ? 'layui-this' : ''; ?>"><i class="icon-icon layui-icon-ios-world"></i>网络文件</li>-->
        ...
        <div class="layui-tab-item layui-show">
		    <div class="layui-tab-content" id="tabBody">
		        ...
		        <div class="layui-tab-item">
		            ...
		            <input type="text" id="info" name="info[filename]" class="layui-input" value=""
		                   placeholder="http://">
		        </div>
		    </div>
		</div>
