<?php /*a:2:{s:78:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/admin/course/edit.html";i:1609916053;s:74:"/www/wwwroot/demo.sdwanyue.com/themes/admin_simpleboot3/public/header.html";i:1602491838;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('course/editPost'); ?>">
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="form-required">*</span>主讲老师</label>
				<div class="col-md-6 col-sm-10">
					<div class="uid_list">
						<ul>
							<li data-uid="<?php echo $data['userinfo']['id']; ?>"><input type="hidden" name="uid" value="<?php echo $data['userinfo']['id']; ?>"><span><?php echo $data['userinfo']['user_nickname']; ?></span><i></i></li>
						</ul>
			...
			<?php if($sort != 0): ?>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-10">
						<div class="uid_list">
							<ul>
								<?php if($data['tutoruid'] > 0): ?>
									<li data-uid="<?php echo $data['tutorinfo']['id']; ?>"><input type="hidden" name="uid" value="<?php echo $data['tutorinfo']['id']; ?>"><span><?php echo $data['tutorinfo']['user_nickname']; ?></span><i></i></li>
								<?php endif; ?>
							</ul>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<select class="form-control" name="gradeid">
                        ...
                        <option value="<?php echo $v['id']; ?>" <?php if($data['gradeid'] == $v['id']): ?>selected<?php endif; ?> ><?php echo $v['name']; ?></option>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<textarea class="form-control" name="des" style="height: 50px;" maxlength="30"><?php echo $data['des']; ?></textarea>最多30个字
				</div>
			</div>
            ...
            <div class="form-group type_bd type_2" style="display:none;">
				...
				<div class="col-md-6 col-sm-10">
					<input class="form-control" id="js-file-input3" type="text" name="type_video" style="width: 300px;display: inline-block;" title="文件名称" value="<?php echo $data['url']; ?>">
            ...
            <div class="form-group type_bd type_3" style="display:none;">
				...
				<div class="col-md-6 col-sm-10">
					<input class="form-control" id="js-file-input4" type="text" name="type_audio" style="width: 300px;display: inline-block;" title="文件名称" value="<?php echo $data['url']; ?>">
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					...
					<select class="form-control" disabled>
                        ...
                        <option value="<?php echo $key; ?>" <?php if($data['paytype'] == $key): ?>selected<?php endif; ?>><?php echo $v; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
				</div>
			</div>
            ...
            <div class="form-group" id="paytype_val" style="display:none;">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-payval" name="payval" value="<?php echo $data['payval']; ?>"> 添加价格时最多保留2位小数
				</div>
			</div>
            <?php if($sort == 1): ?>
            <div class="form-group paytype_bd paytype_1" style="display:none;">
				...
				<div class="col-md-6 col-sm-10">
					<select class="form-control" name="ismaterial" id="ismaterial">
                        ...
                        <option value="1" <?php if($data['ismaterial'] == '1'): ?>selected<?php endif; ?>>是</option>
                    </select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<select class="form-control" name="mode" id="mode">
                        ...
                        <option value="<?php echo $key; ?>" <?php if($data['mode'] == $key): ?>selected<?php endif; ?>><?php echo $v; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>  
            ...
            <div id="paytype_bd" style="display:none;">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-10">
                        <select class="form-control" name="trialtype" id="trialtype">
                            ...
                            <option value="<?php echo $key; ?>" <?php if($data['trialtype'] == $key): ?>selected<?php endif; ?>><?php echo $v; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group trialtype_bd" id="trialval_2" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-10">
                        <input type="text" class="form-control" id="input-trialval_2" name="trialval_2" value="<?php echo $data['trialval']; ?>">秒 开始的多少秒可看
                    </div>
                </div>
                <div class="form-group trialtype_bd" id="trialval_1" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-10">
                        <input type="text" class="form-control" id="input-trialval_1" name="trialval_1" value="<?php echo $data['trialval']; ?>">%  范围：1-99
                    </div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<select class="form-control" name="status" id="status">
                        <option value="1" <?php if($data['status'] == '1'): ?>selected<?php endif; ?>>立即上架</option>
                        <option value="-1" <?php if($data['status'] == '-1'): ?>selected<?php endif; ?>>暂不上架</option>
                        <option value="2" <?php if($data['status'] == '2'): ?>selected<?php endif; ?>>定时上架</option>
                    </select>
				</div>
			</div>
            
            <div class="form-group status_bd" <?php if($data['status'] != 2): ?>style="display:none;"<?php endif; ?>>
				<label for="input-shelvestime" class="col-sm-2 control-label"><span class="form-required">*</span>上架时间</label>
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control js-bootstrap-datetime" id="input-shelvestime" name="shelvestime"  aria-invalid="false" autocomplete="off" value="<?php echo date('Y-m-d H:i:s',$data['shelvestime']); ?>"> 格式：2020-01-01 00:00:00
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control js-bootstrap-datetime" id="input-starttime" name="starttime"  aria-invalid="false" autocomplete="off" value="<?php echo date('Y-m-d H:i:s',$data['starttime']); ?>"> 格式：2020-01-01 00:00:00
				</div>
			</div>
            <div class="form-group">
				<label for="input-endtime" class="col-sm-2 control-label"><span class="form-required">*</span>下课时间</label>
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control js-bootstrap-datetime" id="input-endtime" name="endtime"  aria-invalid="false" autocomplete="off" value="<?php echo date('Y-m-d H:i:s',$data['endtime']); ?>"> 格式：2020-01-01 00:00:00
				</div>
			</div>
            <div class="form-group">
				<label for="input-intr" class="col-sm-2 control-label"><span class="form-required"></span>听课指南</label>
				<div class="col-md-6 col-sm-10">
					<textarea class="form-control" name="intr" style="height: 50px;" maxlength="200"><?php echo $data['intr']; ?></textarea> 留空为显示默认指南 最多200字
				</div>
			</div>
            <?php endif; ?>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<script type="text/plain" id="info" name="info"><?php echo $data['info']; ?></script> 学员购买前可看
				</div>
			</div>
