<?php /*a:2:{s:72:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/menu/edit.html";i:1608272630;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<form method="post" class="layui-form js-ajax-form" action="<?php echo url('menu/editPost'); ?>"  style="padding: 20px 30px 0 0;">
	<div class="layui-tab-content">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" id="input-app" name="app" value="<?php echo $data['app']; ?>">
			</div>
		</div>
		<div class="layui-form-item">
			<label for="input-controller" class="layui-form-label"><span class="form-required">*</span>控制器</label>
			<div class="layui-input-inline">
				<input type="text" class="layui-input" id="input-controller" name="controller" value="<?php echo $data['controller']; ?>">
			</div>
		</div>
		<div class="layui-form-item">
			<label for="input-action" class="layui-form-label"><span class="form-required">*</span>方法</label>
			<div class="layui-input-inline">
				<input type="text" class="layui-input" id="input-action" name="action" value="<?php echo $data['action']; ?>">
			</div>
		</div>
		<div class="layui-form-item">
			<label for="input-param" class="layui-form-label">参数</label>
			<div class="layui-input-inline">
				<input type="text" class="layui-input" id="input-param" name="param" value="<?php echo $data['param']; ?>">
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px">
				<input type="text" class="layui-input" id="input-icon"  lay-filter="iconFonts" name="icon" value="<?php echo $data['icon']; ?>">
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<textarea class="layui-textarea" id="input-remark" name="remark"><?php echo $data['remark']; ?></textarea>
			</div>
		</div>
		<div class="layui-form-item">
...
<script>
    layui.config({
        base: '/themes/admin_htcyltd/public/layuiadmin/layui/'  // 配置你下载的iconFonts文件夹路径
    }).extend({
    ...
    layui.use(['element','form', 'jquery', 'IconFonts'], function () {
         ...
         * 默认选选中图标
         */
        IconFonts.checkIcon("iconFonts","<?php echo $data['icon']; ?>","layui_icon");
    });
</script>
</body>
</html>