<?php /*a:2:{s:89:"D:\My_project\Wanyue-knowledge-payment-admin/themes/admin_htcyltd/admin\course\index.html";i:1610347212;s:84:"D:\My_project\Wanyue-knowledge-payment-admin/themes/admin_htcyltd/public\header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-page-header-content">
                        <div class="layui-card-body">
                            <div class="layui-ui-page-header-title" >
                                <?php if(input('sort') == 0): ?>
                                付费内容<span class="layui-badge-rim page-content">付费内容信息</span>
                        ...
                        <div class="layui-tab layui-tab-brief">
                            <ul class="layui-tab-title layui-nav" id="tabHeader">
                                <li class="layui-this layui-nav-item"><a href="<?php echo url('course/index',['sort'=>$sort]); ?>">列表</a></li>
<!--                                <li><a href="javascript:admin.openIframeLayer('<?php echo url('course/add',['sort'=>$sort]); ?>','<?php echo lang('ADMIN_USER_ADD'); ?>',{btn: ['保存','关闭'],area:['640px','50%'],end:function(){location.reload();}});"><?php echo lang('ADD'); ?></a></li>-->
                                <li class="layui-nav-item"><a href="<?php echo url('course/add',['sort'=>$sort]); ?>"><?php echo lang('ADD'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="layui-page-content">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form class="layui-form" method="post" action="<?php echo url('course/index',['sort'=>$sort]); ?>">
                            <div class="layui-form-item layuiadmin-card-text" style="margin-bottom: 0;">
                                ...
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        ...
                                        <a class="layui-btn layui-btn-danger btn-danger" href="<?php echo url('course/index',['sort'=>$sort]); ?>">清空</a>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="layui-page-content">
                <div class="layui-card">
                    <form method="post" class="layui-card-body js-ajax-form" action="<?php echo url('course/listOrder'); ?>">
                        ...
                        <table class="layui-table treeTable" id="menus-table" lay-even lay-skin="nob" lay-size="lg">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($vo['sort'] == 1): ?>
                                            <a class="layui-bo layui-bo-small layui-bo-succes js-ajax-dialog-btn" href='<?php echo url("lesson/index",array("courseid"=>$vo["id"])); ?>'>课时管理</a>
                                            <div class="new-divider new-divider-vertical"></div>
                                        <?php endif; ?>

                                        <a class="layui-bo layui-bo-small layui-bo-succes" href='<?php echo url("coursebuy/index",array("courseid"=>$vo["id"])); ?>'>购买详情</a>
                                        <div class="new-divider new-divider-vertical"></div>

                                        <?php if($vo['status'] > 0): ?>
                                            <a class="layui-bo layui-bo-small layui-bo-waring js-ajax-dialog-btn" href="<?php echo url("course/setstatus",array("id"=>$vo["id"],"status"=>"-2")); ?>">下架</a>
                                            <?php else: ?>
                                            <a class="layui-bo layui-bo-small layui-bo-succes js-ajax-dialog-btn" href="<?php echo url("course/setstatus",array("id"=>$vo["id"],'status'=>'1')); ?>">上架</a>
                                        <?php endif; ?>
                                        <div class="new-divider new-divider-vertical"></div>

                                        <a class="layui-bo layui-bo-small layui-bo-checked" href="<?php echo url("course/edit",array("id"=>$vo["id"])); ?>"><?php echo lang('EDIT'); ?></a>
                                        <div class="new-divider new-divider-vertical"></div>
                                        <a class="layui-bo layui-bo-small layui-bo-close js-ajax-delete" href="<?php echo url('course/del',array('id'=>$vo['id'])); ?>" <?php if($vo['views'] > 0): ?>data-msg="已有<?php echo $vo['views']; ?>人学习，确定要删除么？"<?php endif; ?>><?php echo lang('DELETE'); ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
