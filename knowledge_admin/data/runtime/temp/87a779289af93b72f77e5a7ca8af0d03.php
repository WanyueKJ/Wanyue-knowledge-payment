...
<div class="my_container">
    ...
    <div class="my_right">
        ...
        <div class="my_right_button">
            <ul class="my_class_title">
                <li class="my_active">全部</li>
                <li>未开始</li>
                <li>学习中</li>
                <li>已学完</li>
            </ul>

            <div class="my_content kc">
                <div class="packs">
                    <ul>
                ...
                <div class="packs">
                    <ul>
                        <?php if(is_array($nostartlist) || $nostartlist instanceof \think\Collection || $nostartlist instanceof \think\Paginator): $i = 0; $__LIST__ = $nostartlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            <li>
                                <a href="/student/detail/class?id=<?php echo $item['id']; ?>">
                                    <div class="content">
                                        <div class="top"
                ...
                <div class="packs">
                    <ul>
                        <?php if(is_array($handlist) || $handlist instanceof \think\Collection || $handlist instanceof \think\Paginator): $i = 0; $__LIST__ = $handlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            <li>
                                <a href="/student/detail/class?id=<?php echo $item['id']; ?>">
                                    <div class="content">
                                        <div class="top"
                ...
                <div class="packs">
                    <ul>
                        <?php if(is_array($overlist) || $overlist instanceof \think\Collection || $overlist instanceof \think\Paginator): $i = 0; $__LIST__ = $overlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            <li>
                                <a href="/student/detail/class?id=<?php echo $item['id']; ?>">
                                    <div class="content">
                                        <div class="top"
