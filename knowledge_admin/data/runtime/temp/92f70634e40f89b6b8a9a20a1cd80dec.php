...
<body>
        ...
        <div class="middle">
            ...
            <div class="ul">
                ...
                <div id="lb" class="right">
                    <div class="li active zhibo-info" data-id="3">直播</div>
                    <div class="li neirong-info" data-id="4">内容</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="less_list_less_info less_list" <?php if($keywords != ''): ?>style="margin-top:80px;"<?php endif; ?>>
        <ul>
