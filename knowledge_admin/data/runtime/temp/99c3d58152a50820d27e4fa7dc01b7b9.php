<?php /*a:2:{s:76:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/admin/knowledge/add.html";i:1612836705;s:70:"/www/wwwroot/demo.sdwanyue.com/themes/admin_htcyltd/public/header.html";i:1609814284;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    ...
    <form method="post" class="layui-form js-ajax-form" style="margin-top: 20px;" action="<?php echo url('knowledge/addPost'); ?>">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-tab layui-tab-brief">
                    <ul class="layui-tab-title">
                        <li><a href="<?php echo url('knowledge/index',['sort'=>$sort]); ?>">列表</a></li>
                        <li class="layui-this"><a href="<?php echo url('knowledge/add',['sort'=>$sort]); ?>">添加</a></li>
                    </ul>
                    <div class="layui-card-body">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select class="layui-input" name="paytype" id="paytype">
