	...
	<view class="page">
		<template v-if="type == 2">
			<view class="video-wrap">
				<video class="video-wrap" :src="url" :poster="thumb" controls="true" autoplay="true" muted="false"></video>
			</view>
		</template>
		<template v-else-if="type == 3">
			<view class="video-wrap3">
				...
				<!-- <video id="myVideo" :src="url" class="hidden" autoplay="false" @timeupdate="timeupdate" ref="video" @loadedmetadata="loadedmetadata"></video>
